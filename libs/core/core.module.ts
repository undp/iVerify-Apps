...
import { LocationInitService } from './locations/location.init';
/**
 * DEBUGGING
 */
...
export function locationInitServiceFactory(
    startupService: LocationInitService
): Function {
    return () => startupService.get();
}
...
export const BASE_PROVIDERS: any[] = [
    ...
    LocationInitService,
    {
        ...
        provide: APP_INITIALIZER,
        useFactory: locationInitServiceFactory,
        deps: [LocationInitService],
        multi: true,
    },
